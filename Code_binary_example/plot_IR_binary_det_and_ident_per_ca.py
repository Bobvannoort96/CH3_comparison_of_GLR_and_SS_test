# -*- coding: utf-8 -*-
"""
Per-Ca figures for the binary hypothesis example (DETECTION + IDENTIFICATION).
...
if __name__ == "__main__":
    ...
    figSavingDir = (
        r"C:\Users\bgvannoort\Documents\Dissertation\Chapter 5 SS vs GLR\Figures\binary_example\det_and_ident"
    )
    ...
    for type_of_ci_matrix in types_of_ci_matrices:
        ...
        if type_of_ci_matrix == "outlier":
            loadingDir = os.path.join(savingDirBase, "2 Outliers", "Det+Ident", "Data")
        elif type_of_ci_matrix == "linearly_dependent":
            loadingDir = os.path.join(savingDirBase, "Ci-almost-lin-dependent", "Det+Ident", "Data")
        elif type_of_ci_matrix == "almost_in_A":
            loadingDir = os.path.join(
                savingDirBase, "Ci-columns-almost-in-A", "Det+Ident", "AL=15", "Data"
            )
        ...
        cb_mean.ax.text(1.35, 0.98, s, transform=cb_mean.ax.transAxes,
        ...
        # =====================================================
        fig.subplots_adjust(top=0.985, bottom=0.075, left=0.015, right=0.88,
